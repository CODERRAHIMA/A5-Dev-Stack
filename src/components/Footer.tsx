    ...
    <div className="border-t border-gray-100 mt-8 md:mt-18">
      <div className="py-18 grid grid-cols-5 justify-between gap-2 max-w-7xl mx-auto font-jakarta">
        <div className="col-span-5 md:col-span-2 flex flex-col items-center md:items-start gap-2">
          ...
          <p className="text-sm text-center md:text-left max-w-sm md:max-w-md text-gray-500">
            Curated tools, technologies, and resources for developers building
            modern software.
          </p>
          <ul className="flex flex-wrap items-center gap-4 md:gap-2 text-sm font-semibold text-gray-600 mt-4">
            <li>
              <a href="#">GitHub</a>
            </li>
      ...
      <div className="flex justify-between px-4 md:px-0 py-4 md:py-8 mb-6 md:mb-0 text-xs md:text-sm text-[#94A3B8] max-w-7xl mx-auto border-t-2 border-gray-100">
